...
import { acceptAgencyTerms } from "@/actions/agency-terms";
import { createClient } from "@/lib/supabase/client";

/**
 * Blocking Terms & Conditions acceptance modal shown to an agency owner whose
 * agency has not yet accepted. Rendered from the dashboard layout, so it
 * appears on every login until the owner accepts (or signs out).
 */
export function AgencyTermsGate({ agencyName }: { agencyName: string }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="agency-terms-gate-title"
      ...
      >
        <div className="p-6 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="agency-terms-gate-title" className="text-lg font-semibold leading-tight">
                Terms &amp; Conditions
              </h2>
          ...
          <p className="text-sm leading-relaxed">
            ...
            <span className="font-semibold">&ldquo;{agencyName}&rdquo;</span> and we accept the Terms &amp; Conditions
            by Sugg.
          </p>
