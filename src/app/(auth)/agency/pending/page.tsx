...
import { Clock, CheckCircle, Mail, Briefcase } from "lucide-react";
...
export default function AgencyPendingPage() {
  const steps = [
    ...
    { icon: CheckCircle, label: "Identity Verified", done: true },
    { icon: Clock, label: "Admin Review", done: false },
    { icon: Mail, label: "Welcome & Login Access", done: false },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md text-center">
        ...
        <p className="text-gray-500 text-sm mb-8">
          Your agency has been registered and verified. Our team will review and approve your account,
          after which the owner can log in.
        </p>
